  ...
  return (
    <div>
      ...
      <div className="bg-white py-3">
        ...
        <button className="border border-gray-200 rounded-md py-2 px-4 bg-gray-100 text-sm font-semibold cursor-pointer">Update password</button>
        </div>
        <div className="border border-1 border-gray-200 mt-4"></div>
        <div className="flex flex-row justify-around p-4">
          <div className="flex flex-col items-start">
            <h3 className="font-semibold text-sm">My Reviews</h3>
            <h3 className="font-semibold text-xl text-gray-500">{reviewsLength}</h3>
          </div>
          <div className="flex flex-col items-start">
            <h3 className="font-semibold text-sm ">My Saved Cafe's</h3>
            <h3 className="font-semibold text-xl text-gray-500">{cafesLength}</h3>
          </div>
        </div>
      </div>
    </div>
